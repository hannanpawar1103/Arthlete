        ...
        <div id="choose-plan">
          ...
          >
            ...
            <p className="text-sm mb-7">
              ...
              enthusiasts. Join us to discuss workout strategies, nutrition{" "}
              <br />
              insights, and the latest trends in health and fitness. Connect
              with like-minded individuals who share your passion for <br />{" "}
              achieving your fitness goals. Elevate your fitness journey with us
              on Discord!
            </p>
            <a
